...
class IFCPropertyWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.property_tree.setEditTriggers(QAbstractItemView.EditTrigger.CurrentChanged)  # open editor upon first click
    ...
    def add_inverse_attributes_in_tree(self, ifc_object, parent_item, recursion=0):
        ...
        for att_idx, att_name in enumerate(attributes):
            ...
            attribute_item0.setData(ifc_object, Qt.ItemDataRole.UserRole)  # remember the owner of this attribute
            attribute_item0.setData(att_name, Qt.ItemDataRole.UserRole + 1)  # name
            attribute_item0.setData(att_value, Qt.ItemDataRole.UserRole + 2)  # value
            attribute_item0.setData(att_type, Qt.ItemDataRole.UserRole + 3)  # type
            attribute_item0.setData(att_idx, Qt.ItemDataRole.UserRole + 4)  # index
            ...
            if len(inv_attribute_tuple) > 0:
                for i, nested_att in enumerate(inv_attribute_tuple):
                    ...
                    # nested_attribute_item1.setData(nested_att, Qt.ItemDataRole.UserRole)  # remember the owner of this attribute
                    # nested_attribute_item0.setData('', Qt.ItemDataRole.UserRole + 1)  # name
                    # nested_attribute_item0.setData('', Qt.ItemDataRole.UserRole + 2)  # value
                    # nested_attribute_item0.setData(att_class, Qt.ItemDataRole.UserRole + 3)  # type
                    # nested_attribute_item0.setData(i, Qt.ItemDataRole.UserRole + 4)  # index
    ...
    def add_attributes_in_tree(self, ifc_object, parent_item, recursion=0):
        ...
        for att_idx in range(0, len(ifc_object)):
            ...
            attribute_item1.setData(ifc_object, Qt.ItemDataRole.UserRole)  # remember the owner of this attribute
            attribute_item1.setData(att_name, Qt.ItemDataRole.UserRole + 1)  # name
            attribute_item1.setData(att_value, Qt.ItemDataRole.UserRole + 2)  # value
            attribute_item1.setData(att_type, Qt.ItemDataRole.UserRole + 3)  # type
            attribute_item1.setData(att_idx, Qt.ItemDataRole.UserRole + 4)  # index
            if att_name == 'NominalValue':
                attribute_item1.setData(ifc_object.NominalValue, Qt.ItemDataRole.UserRole + 5)  # sub_object
            ...
            if attribute is not None and recursion < 20:
                ...
                if att_type == 'AGGREGATE OF DOUBLE':
                    ...
                    for counter, value in enumerate(attribute):
                        ...
                        # nested_item1.setData(nested_entity, Qt.ItemDataRole.UserRole)  # remember the owner of this attribute
                        # nested_item1.setData(att_name, Qt.ItemDataRole.UserRole + 1)  # name
                        # nested_item1.setData(att_value, Qt.ItemDataRole.UserRole + 2)  # value
                        # nested_item1.setData(att_type, Qt.ItemDataRole.UserRole + 3)  # type
                        # nested_item1.setData(att_idx, Qt.ItemDataRole.UserRole + 4)  # index
        ...
        for index, prop in enumerate(property_set.HasProperties):
            if self.show_all:
                ...
                if prop.is_a('IfcPropertySingleValue'):
                    ...
                    prop_item1.setData(prop, Qt.ItemDataRole.UserRole)  # object
                    prop_item1.setData(prop.Name, Qt.ItemDataRole.UserRole + 1)  # name
                    prop_item1.setData(prop_value, Qt.ItemDataRole.UserRole + 2)  # value
                    prop_item1.setData(unit, Qt.ItemDataRole.UserRole + 3)  # type
                    prop_item1.setData(index, Qt.ItemDataRole.UserRole + 4)  # index
                    prop_item1.setData(prop, Qt.ItemDataRole.UserRole + 5)  # sub_object
                    ...
                    for nested_index, nested_prop in enumerate(prop.HasProperties):
                        ...
                        prop_nested_item1.setData(nested_prop, Qt.ItemDataRole.UserRole)  # object
                        prop_nested_item1.setData(nested_name, Qt.ItemDataRole.UserRole + 1)  # name
                        prop_nested_item1.setData(nested_value, Qt.ItemDataRole.UserRole + 2)  # value
                        prop_nested_item1.setData(nested_unit, Qt.ItemDataRole.UserRole + 3)  # type
                        prop_nested_item1.setData(nested_index, Qt.ItemDataRole.UserRole + 4)  # index
                        prop_nested_item1.setData(nested_prop, Qt.ItemDataRole.UserRole + 5)  # sub_object
                        property_item0.appendRow([prop_nested_item0, prop_nested_item1, prop_nested_item2])
                else:
                    property_item0 = QStandardItem(prop.Name)
                    property_item1 = QStandardItem(prop_value)
                    property_item2 = QStandardItem(unit)
                    property_item1.setData(prop, Qt.ItemDataRole.UserRole)
                    property_item1.setData(prop.Name, Qt.ItemDataRole.UserRole + 1)  # name
                    property_item1.setData(prop_value, Qt.ItemDataRole.UserRole + 2)  # value
                    property_item1.setData(unit, Qt.ItemDataRole.UserRole + 3)  # type
                    property_item1.setData(index, Qt.ItemDataRole.UserRole + 4)  # index
                    property_item1.setData(prop, Qt.ItemDataRole.UserRole + 5)  # sub_object
    ...
    def add_file_header(self, ifc_file):
        ...
        header_item.setData(ifc_file, Qt.ItemDataRole.UserRole)
    ...
    def add_object_data(self, ifc_object):
        ...
        if self.follow_assignments and hasattr(ifc_object, 'HasAssignments'):
            ...
            for assignment in ifc_object.HasAssignments:
                ...
                ass_item0.setData(assignment, Qt.ItemDataRole.UserRole)
                ...
                # sub_object = index.data(Qt.ItemDataRole.UserRole + 5)
        ...
        if self.show_all and (self.follow_defines or self.follow_properties) and hasattr(ifc_object,
            ...
            for definition in ifc_object.IsDefinedBy:
                ...
                def_item0.setData(definition, Qt.ItemDataRole.UserRole)
                # att_name  = index.data(Qt.ItemDataRole.UserRole + 1)
                # att_value = index.data(Qt.ItemDataRole.UserRole + 2)
                # att_type  = index.data(Qt.ItemDataRole.UserRole + 3)
                # att_index = index.data(Qt.ItemDataRole.UserRole + 4)
        ...
        if not self.show_all and (self.follow_defines or self.follow_properties) and hasattr(ifc_object, 'IsDefinedBy'):
            ...
            for definition in ifc_object.IsDefinedBy:
                if self.follow_defines and definition.is_a('IfcRelDefinesByType'):
                    ...
                    type_item0.setData(type_item0, Qt.ItemDataRole.UserRole)
                    # att_name  = index.data(Qt.ItemDataRole.UserRole + 1)
                    # att_value = index.data(Qt.ItemDataRole.UserRole + 2)
                    # att_type  = index.data(Qt.ItemDataRole.UserRole + 3)
                    # att_index = index.data(Qt.ItemDataRole.UserRole + 4)
                    ...
                    type_item0.setData(type_object, Qt.ItemDataRole.UserRole)
                ...
                if self.follow_properties and definition.is_a('IfcRelDefinesByProperties'):
                    ...
                    prop_item0.setData(property_set, Qt.ItemDataRole.UserRole)
                    # att_name  = index.data(Qt.ItemDataRole.UserRole + 1)
                    # att_value = index.data(Qt.ItemDataRole.UserRole + 2)
                    # att_type  = index.data(Qt.ItemDataRole.UserRole + 3)
                    # att_index = index.data(Qt.ItemDataRole.UserRole + 4)
        ...
        if self.follow_associations and hasattr(ifc_object, 'HasAssociations'):
            ...
            for association in ifc_object.HasAssociations:
                ...
                def_item0.setData(association, Qt.ItemDataRole.UserRole)
                # att_name  = index.data(Qt.ItemDataRole.UserRole + 1)
                # att_value = index.data(Qt.ItemDataRole.UserRole + 2)
                # att_type  = index.data(Qt.ItemDataRole.UserRole + 3)
                # att_index = index.data(Qt.ItemDataRole.UserRole + 4)
                    ...
                    if not self.show_all:  # streamlined display
                        if relating_material.is_a('IfcMaterialList'):
                            for mat in relating_material.Materials:
                                ...
                                mat_item0.setData(mat, Qt.ItemDataRole.UserRole)
                            ...
                            for layer in relating_material.MaterialLayers:
                                ...
                                mat_item0.setData(layer, Qt.ItemDataRole.UserRole)
    ...
    def reset(self):
        ...
        self.model.setHeaderData(2, Qt.Orientation.Horizontal, "ID/Type")
